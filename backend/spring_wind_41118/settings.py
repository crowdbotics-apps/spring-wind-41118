"""
Django settings for spring_wind_41118 project.
...
ROOT_URLCONF = 'spring_wind_41118.urls'
...
WSGI_APPLICATION = 'spring_wind_41118.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_wind_41118 API",
    "DESCRIPTION": "API documentation for spring_wind_41118 App",
    "VERSION": "v1",
}
